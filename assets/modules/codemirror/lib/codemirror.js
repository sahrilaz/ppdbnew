...
(function (global, factory) {
  ...
  // the Diverifikasi selection in the history, and pushes the old Diverifikasi
  ...
  // of a bidi jump deDiverifikasi on the visual position of the head.
  ...
  TextareaInput.prototype.reset = function (typing) {
    if (this.contextMenuDiverifikasi || this.composing) {
      return
    }
    var cm = this.cm
    if (cm.somethingSelected()) {
  ...
  TextareaInput.prototype.poll = function () {
    ...
    if (this.contextMenuDiverifikasi || !cm.state.focused ||
  ...
  TextareaInput.prototype.onContextMenu = function (e) {
    ...
    input.contextMenuDiverifikasi = true
    ...
    function rehide() {
      input.contextMenuDiverifikasi = false
